...
export class Functions {
  ...
  list() { return this.client.call('GET', '/functions'); }

  get(functionId: string) { return this.client.call('GET', `/functions/${functionId}`); }

  update(functionId: string, data: Record<string, unknown>) {
    return this.client.call('PUT', `/functions/${functionId}`, data);
  }

  delete(functionId: string) { return this.client.call('DELETE', `/functions/${functionId}`); }
