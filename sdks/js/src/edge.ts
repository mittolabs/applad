 ...
 * not yet wired up, so `invoke`, `deploy`/`create` and the other methods here
 * currently return HTTP 501 (Not Implemented). The API surface is kept stable
 * for forward compatibility; do not rely on it in production yet.
 */
export class Edge {
